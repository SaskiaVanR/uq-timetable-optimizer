...
def check_codes():
    ...
    subject_codes = list(filter(None, subject_codes))  # Filter out empty values
...
subject_2_tbx = tk.Entry(window, width=entry_width, font=(font_body, font_body_size))
subject_3_lbl = tk.Label(window, text="Subject 3", justify="right", font=(font_body, font_body_size))
subject_3_tbx = tk.Entry(window, width=entry_width, font=(font_body, font_body_size))
