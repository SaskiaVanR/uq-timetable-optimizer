...
subject_1_lbl.grid(row=0, column=0, sticky="e", padx=5, pady=5)
subject_1_tbx.grid(row=0, column=1, padx=5, pady=5)
subject_2_lbl.grid(row=1, column=0, sticky="e", padx=5, pady=5)
subject_2_tbx.grid(row=1, column=1, padx=5, pady=5)
subject_3_lbl.grid(row=2, column=0, sticky="e", padx=5, pady=5)
subject_3_tbx.grid(row=2, column=1, padx=5, pady=5)
subject_4_lbl.grid(row=3, column=0, sticky="e", padx=5, pady=5)
subject_4_tbx.grid(row=3, column=1, padx=5, pady=5)
